    ...
    def logits(
        ...
        *,
        ...
        if restricted_indices is not None:
            prompts_embeds = prompts_embeds[restricted_indices] if prompts_embeds is not None else None
            tokenized_prompts = tokenized_prompts[restricted_indices] if tokenized_prompts is not None else None
            text_features = text_features[restricted_indices] if text_features is not None else None
